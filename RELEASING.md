# Releasing foldsite and minting a Zenodo DOI
...
1. Sign in at https://zenodo.org with GitHub, open **Settings -> GitHub**, and flip the
   `headsparkle/foldsite` switch to **On**. (`.zenodo.json` in this repo supplies the metadata.)
2. On GitHub, **Releases -> Draft a new release**, tag `v0.1.0`, title `foldsite 0.1.0`, publish.
